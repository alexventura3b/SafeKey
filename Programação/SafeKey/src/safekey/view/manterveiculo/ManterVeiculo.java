 ...
 */
package safekey.view.manterveiculo;

import safekey.SafeKey;
import safekey.controller.ControleVeiculo;
...
public class ManterVeiculo {
    ...
    public static void montarTela() throws SQLException, ClassNotFoundException {
        ...
        switch (ops) {
            ...
            case 5:
                ...
                break;
            default: {
                JOptionPane.showMessageDialog(null, "RETORNANDO AO MENU VEICULO");
                montarTela();
            }
        }
    }
    ...
    public static void inserir() throws SQLException, ClassNotFoundException {
        JOptionPane.showMessageDialog(null, "INSERIR VEICULO");
